  ...
  */
      ...
      if (prompt != null) {
        ...
        if (typeof result === 'string') {
          if (typeof getUserConfirmation === 'function') {
            ...
            warning_1$2(false, 'A history needs a getUserConfirmation function in order to use a prompt message');
  ...
  var createMemoryHistory = function createMemoryHistory() {
    ...
    var push = function push(path, state) {
      warning_1$2(!((typeof path === 'undefined' ? 'undefined' : _typeof$2(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
    ...
    var replace = function replace(path, state) {
      warning_1$2(!((typeof path === 'undefined' ? 'undefined' : _typeof$2(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
